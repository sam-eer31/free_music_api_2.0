...
for line in lines:
    ...
    if 'Total Lines: 164' in text and 'Header.tsx' in text:
        ...
        if m:
            ...
            open('frontend/src/components/Header.tsx', 'w', encoding='utf-8').write('\n'.join(clean_lines))
            print('Restored Header.tsx')
        break
    if 'globals.css' in text and 'Total Lines' in text:
        # maybe do this too if I want, but let's do Header first
        pass
